...
texfile = '/home/tzafrir/png/04.png'
texfile2 = '/home/tzafrir/png/04.png'
...
def display():
   ...
   for i in range(10):
     ...
     deg = i * 36.0
     d = 6.0
     glTranslated(d * math.cos(deg), 0.0, d * math.sin(deg))
     glutSolidTeapot(1.0)
     glPopMatrix()
...
def drawShape():
  ...
  glEnd()
  glBegin(GL_POLYGON)
  glVertex3f( 0.5, 0.0, 1.0) #d
  glVertex3f( 0.5, 1.0, 1.0) #c
...
def texturize(img_data, w, h):
  genparams = [ 0.3, 0.7, 1.0, 0.0 ]
  tgenparams = [0.01, 1.0, 0.0, 0.0 ]
  glPixelStorei(GL_UNPACK_ALIGNMENT, 1)
  glTexImage2D(GL_TEXTURE_2D, 0, 4, w, h, 0, GL_RGB, GL_UNSIGNED_BYTE, img_data)
  glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT)
  glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT)
#  glTexGeni(GL_S, GL_TEXTURE_GEN_MODE, GL_OBJECT_LINEAR)
 # glTexGenfv(GL_S, GL_OBJECT_PLANE, genparams)
